...
$(document).ready(function () {
    ...
    $.getJSON("packages/" + dPackage + ".json", function (data) {
        ...
        var extra = {
            "<img class=\"icon\" src=\"icons/twitter.png\"><span>Find me on Twitter (@iGosuuu)</span>": "https://twitter.com/iGosuuu",
            "<img class=\"icon\" src=\"icons/email.png\"><span>Send me an email</span>": "mailto:tocuong.kr@gmail.com",
            "<img class=\"icon\" src=\"icons/like.png\"><span>Buy me a &#x1F37A; via <span style=\"font-style:italic;font-weight:bold;\"><span style=\"color:#253b80;\">Pay</span><span style=\"color:#419bd7;\">Pal</strong></span></span>": "https://paypal.me/igosu"
        };
        $.extend(links, extra);
